...
class MakeBackEndModuleCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:backendmodule {name}';
     ...
     * @var string
     */
    protected $description = 'Create a new Module for back-end';
     ...
     */
    public function handle(Filesystem $files, MakeSimpleBackEndModule $backEndModule)
    {
        $this->files = $files;
