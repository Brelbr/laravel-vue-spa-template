...
class LoginController extends Controller
{
     ...
     * ## При успешной авторизации возвращает токен доступа
     * ## Токен используется в заголовках ("Authorization": "Bearer {token}") для доступа к API
     * ## Параметр device_name служит для определения какому типу приложения был выдан токен (мобильное, веб, или еще что то)
     * @lrd:end
     * @QAparam email string  User_email
     * @QAparam password string User_password
     * @QAparam device_name string Application name
     */
